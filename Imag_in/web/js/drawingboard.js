...
DrawingBoard.Board = function(id, opts) {
	...
	var tpl = '<div class="drawing-board-canvas-wrapper"></canvas><canvas id="canvas-drawing-id" class="drawing-board-canvas"></canvas><div class="drawing-board-cursor drawing-board-utils-hidden"></div></div>';
